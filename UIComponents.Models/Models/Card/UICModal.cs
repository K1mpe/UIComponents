...
using static UIComponents.Models.Models.Card.UICModal;
...
namespace UIComponents.Models.Models.Card
{
    public class UICModal : UIComponent, IUICCardLike
    {
        ...
        public ModalSize Width { get; set; } = UIComponents.Defaults.Models.Card.UICModal.Width;
...
namespace UIComponents.Defaults.Models.Card
{
    public static class UICModal
    {
        ...
        /// Move the content out of its current location and place it on the body
        /// </summary>
        public static bool MoveModalToBody { get; set; }

        public static bool ShowCloseButton { get; set; } = true;
        public static bool DisableCloseOnClickout { get; set; }
        public static bool DisableEscapeKeyToClickout { get; set; }

        /// <summary>
        /// Open the modal as soon as this is loaded on the page
        /// </summary>
        public static bool OpenOnLoad { get; set; } = true;

        /// <summary>
        /// When the modal is closed, remove the html from the page.
        /// </summary>
        public static bool RemoveModalOnClose { get; set; } = true;

        public static ModalSize Width { get; set; } = ModalSize.Auto;
    }
}
