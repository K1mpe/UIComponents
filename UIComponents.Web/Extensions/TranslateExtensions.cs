...
public static class TranslateExtensions
{
    ...
    public static async Task<IHtmlContent>Translate(this IHtmlHelper htmlHelper, ILanguageService languageService, ITranslateable translateable, string brackets = "'")
    {
