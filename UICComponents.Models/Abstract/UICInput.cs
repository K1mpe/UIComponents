namespace UIComponents.ComponentModels.Abstract
{
    ...
    public abstract class UICInput : UIComponent
    {
        ...
        /// </summary>
        public ITranslationModel Placeholder { get; set; }
        ...
        /// </summary>
        public ITranslationModel DisplayName { get; set; }
        ...
        #region Converters
        public UICInputGroup ConvertToInputGroup(ITranslationModel labelText)
        {
            return new UICInputGroup(labelText, this);
        }
        #endregion
