...
{
    Task<ValidationRuleResult> DefaultValidationErrors(TValidator validator, PropertyInfo propertyInfo, object obj, CancellationToken cancellationToken = default);
}
